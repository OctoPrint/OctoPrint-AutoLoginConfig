...
class Autologin_configPlugin(octoprint.plugin.SettingsPlugin,
	...
	def get_assets(self):
		...
		return dict(
			...
			less=["less/autologin_config.less"]
		)
	...
	def get_update_information(self):
		...
		# for details.
		return dict(
			autologin_config=dict(
				displayName="Autologin_config Plugin",
...
def __plugin_load__():
	...
	__plugin_implementation__ = Autologin_configPlugin()
